...
//   MonthNextButton,
//   PaginationWrap,
// } from './MonthsStatsTable.styled.jsx';
...
//     const newMonthIndex = (selectedMonthIndex + direction + totalMonths) % totalMonths;
...
//         const fetchedArray = initialArray.map(day => {
...
//           toast.error('Oops! Something went wrong! Please try again!', { duration: 1000 });
//         }
...
//     const left = dayRect.left > 292 ? dayRect.left - 292 : dayRect.left + dayRect.width / 2;
//     setStatsPosition({ top, left });
//   };

//   const borderColor = percent => {
//     if (percent === 100) return '1px solid #32CD32';
//     if (percent > 0 && percent < 100) return '1px solid #FF9D43';
//     return undefined;
//   };
...
//         <MonthSelector>
//           <MonthBackButton onClick={() => handleMonthChange(-1)}>
...
//           </MonthAndYear>
//           <MonthNextButton onClick={() => handleMonthChange(1)}>
//             <svg width="14px" height="14px">
//               <use href={`${SpriteIcons}#icon-chevron-double-up`} />
//             </svg>
//           </MonthNextButton>
...
//   MonthNextButton,
//   PaginationWrap,
// } from './MonthsStatsTable.styled.jsх';
// import { useEffect, useState } from 'react';
// import { DaysGeneralStats } from '../DaysGeneralStats/DaysGeneralStats';
// import SpriteIcons from './sprite.svg';
// import axios from 'axios';
