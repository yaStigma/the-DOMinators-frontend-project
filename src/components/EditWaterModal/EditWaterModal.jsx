...
//     if (waterRecord && waterRecord.userId) {
//       try {
...
//       for (let minute = 0; minute += 5; minute < 60) {
...
//       try {
//         const date = new Date().toISOString().split('T')[0] + 'T' + time + ':00';
//         const userId = waterRecord.userId.$oid || waterRecord.userId; // Обработка userId
//         await dispatch(updateWaterRecord({ userId, date, amount }));
//         setModalVisible(false);
//       } catch (error) {
//         console.error(error);
//       }
